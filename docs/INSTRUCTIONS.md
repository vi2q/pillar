...
| coding-agent | 78.9k | 50.3k | 🔶 着手 (system-prompt 16 + prompt-templates 19 テスト) |
| tui | 17.9k | 16.4k | ❌ 未着手 |
...
- [ ] luaur follow-up PR #40 のレビュー (2026-09-02) — **指摘4点すべて修正済み・push済み (37636ee5)**
  ...
  - [ ] Confirm (user): 修正内容の承認 — pending confirmation
...
3. **pillar-coding-agent**: 着手。system-prompt (16テスト) + prompt-templates (19テスト) 完了。次の候補: keybindings (396行), model-config (300行), skills のディレクトリ走査 (ignore パターン) → その後 agent-session (3.5k行, 依存多数) と package-manager (2.7k行)。
