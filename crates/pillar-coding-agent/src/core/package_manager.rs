...
//!
//! divergences: hosted-git-info is not ported — `parse_git_url` handles
//! protocol URLs, scp-like shorthands, and `git:`-prefixed shorthand
//! `host/owner/repo` forms via the generic parser only; command runners
//! use `std::process::Command` (no stdout-takeover stdio mode); resolve()
//! is synchronous.
...
/// A git source (upstream `GitSource`).
#[derive(Debug, Clone, PartialEq, Eq)]
...
// ============================================================================
// Git URL parsing (upstream utils/git.ts, generic parser subset)
// ============================================================================
